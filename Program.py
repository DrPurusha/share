...
class TestApp(TestWrapper, TestClient):
    ...
    def tickDataOperations_req(self):
        ...
        # ! [reqmktdata]
        self.reqMktData(1000, ContractSamples.AudNzdFx(), "", False, False, [])
    ...
    def tickPrice(self, reqId: TickerId, tickType: TickType, price: float,
        ...
        if tickType == TickTypeEnum.BID:
            print(f'BidPriceH: {floatMaxString(price)}')
        elif tickType == TickTypeEnum.ASK:
            print(f'AskPriceH: {floatMaxString(price)}')
    # ! [tickprice]
    ...
    def tickSize(self, reqId: TickerId, tickType: TickType, size: Decimal):
        ...
        if tickType == TickTypeEnum.BID_SIZE:
            print(f'BidSize: {decimalMaxString(size)}')
        elif tickType == TickTypeEnum.ASK_SIZE:
            print(f'AskSize: {decimalMaxString(size)}')
    # ! [ticksize]
    ...
    def contractOperations(self):
        # ! [reqcontractdetails]
        self.reqContractDetails(211, ContractSamples.AudNzdFx())
        # ! [reqcontractdetails]
